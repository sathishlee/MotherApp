...
public interface LoginInteractor {
    ...
    void checkPickmeId(String pickmeid, String dob, String strdeviceId, String mobileCheck, String mLatitude,
                       String mLongitude, String versionCode,String androidId) ;
