package com.suthishan.multiselectspineer;
...
public class SingleSpinnerSearch extends android.support.v7.widget.AppCompatSpinner implements OnCancelListener{
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        ArrayAdapter<String> adapterSpinner = new ArrayAdapter<>(getContext(), R.layout.textview_spinner, new String[] { spinnerText });
    ...
    public void setItems(List<KeyPairBoolData> items, int position, SpinnerListener listener) {
        ...
        ArrayAdapter<String> adapterSpinner = new ArrayAdapter<>(getContext(), R.layout.textview_spinner, new String[] { defaultText });
        setAdapter(adapterSpinner);
