...
public class MultiSpinner extends AppCompatSpinner implements OnMultiChoiceClickListener, OnCancelListener {
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getContext(), R.layout.textview_spinner, new String[]{spinnerText});
        setAdapter(adapter);
    ...
    public void setItems(LinkedHashMap<String, Boolean> items, MultiSpinnerListener listener) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getContext(), R.layout.textview_spinner, new String[]{defaultText});
        setAdapter(adapter);
